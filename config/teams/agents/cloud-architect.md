...
- Message tech-lead about architecture decisions, cloud service selection, and infrastructure design
- Message devops about IaC implementation, CI/CD pipelines, and deployment strategies
- Message security-engineer about cloud security, IAM, and compliance requirements
- Message fullstack-dev about cloud service integration and environment configuration
...
## Archive Coverage
- Absorbs `hybrid-cloud-architect`.
- Keeps mixed hosting, cross-environment topology, and provider strategy under one active cloud role.
