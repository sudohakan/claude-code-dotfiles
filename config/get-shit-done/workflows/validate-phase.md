...
<required_reading>
@C:/Users/Hakan/.claude/get-shit-done/references/ui-brand.md
</required_reading>
...
```
Task(
  prompt="Read C:/Users/Hakan/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Hakan/.claude/get-shit-done/templates/VALIDATION.md`
